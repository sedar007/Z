...
COPY ["HealthIndicators.sln", "./"]
COPY ["HealthIndicators/HealthIndicators.csproj", "HealthIndicators/"]
...
RUN dotnet publish "HealthIndicators/HealthIndicators.csproj" -c Release -o /app/publish
